...
<div class="navBar" :class="{ noShadow: !isShadow }">
	<div id="nav" ref="nav">
		...
		<router-link class="navLink" to="/component/cytoscape"><span>About</span></router-link>
		<router-link class="navLink" to="/component/genbank"><span>Contact Us</span></router-link>
		<div class="close">
